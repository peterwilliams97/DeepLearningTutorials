...
def load_data(dataset):
    ...
    # input is an numpy.ndarray of 2 dimensions (a matrix) with row's correspond to an example.
    # target is a numpy.ndarray of 1 dimensions (vector)) that have the same length as the number of
